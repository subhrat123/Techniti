            ...
            <section id="landing">
                <div className="h-screen w-full flex flex-col items-center justify-center text-center overflow-hidden relative noselect">
                    ...
                    >
                        ...
                        >
                            <h1 className="text-6xl font-extrabold mb-4 text-[#f4e1c1] drop-shadow-md">
                                ...
                                <span className="inline-flex items-center">
                                     <motion.span className="font-[MedievalSharp] text-4xl mr-2" variants={titleWordVariants}>
                                         {techNeeti[0]}
                                     </motion.span>
                                     <motion.span className="neeti text-5xl" variants={titleWordVariants}>
                                         {techNeeti[1]}
                                     </motion.span>
                                </span>
                            </h1>
                            <motion.p className="text-[#E6C28B] text-sm mb-2" variants={itemVariants}>
                                (The Code Dharma)
                            </motion.p>
                        </motion.div>
                        ...
                        >
                            <a href="https://forms.gle/7418PyQ8kgsJa1Vc7" target="_blank" rel="noopener noreferrer">
                                <motion.button
                    ...
                    >
                        <svg className="w-8 h-8 text-[#E6C28B]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
